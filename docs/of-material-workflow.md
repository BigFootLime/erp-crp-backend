...
Revalidation en cours de fabrication : un dossier validé auparavant peut être revalidé En cours / En pause après revue de ses exigences et du planning. Un dossier clos ou une validation initiale rétroactive reste refusé. Les anciens engagements non rapprochés bloquent aussi la préparation de nouveaux appels client. Vérification ciblée : 17 tests dossier et appels client réussis, compilation complète réussie.
...
Les engagements conservés séparément disposent d’un panneau permanent, de leurs liens achats/lots et des actions des appels client d’origine. Leur réception reste possible ; après libération, la quantité reste disponible en stock et ne réserve ni l’ancien besoin ni le nouveau. Les allocations suivantes conservent leur intervalle de réception. 25 tests serveur ciblés réussis, compilation complète et 124 PREPARE/EXPLAIN réussis. La copie d’opérations de révision utilise TODO, valeur réelle de l’énumération PostgreSQL.

Recette UI 10 h 31 : DT-000002 v1 téléchargé depuis la demande BCF-925, journal GED de téléchargement vérifié ; retour à la demande conservé. OF-856 : fin estimée passée du 14 au 21 septembre après annonce retardée, fin engagée restée au 7 septembre ; deux rapprochements puis revalidation en cours de fabrication réussis avec 15 réservés et 25 attendus conservés une seule fois.
