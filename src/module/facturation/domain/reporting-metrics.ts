...
const CATALOG: MetricDefinition[] = [
  ...
  },
  {
    ...
    availability: "available",
    limitations: [
      "C'est un taux « à l'heure » à la LIGNE, pas un OTIF : « complet » n'a pas de définition validée dans le CERP (livraison partielle tolérée ? seuil ?).",
  ...
  },
  {
    ...
    family: "livraisons",
    label: "OTIF",
    definition: "On Time In Full — livré à l'heure ET complet.",
    formula: "Indisponible.",
    sources: [],
    grain: "Une commande.",
    date_field: "N/A",
    ...
    availability: "deferred",
    limitations: [
      "Bloquant : aucune définition validée de « complet » (tolérance de sous-livraison, groupage autorisé, périmètre commande ou ligne) ni de la date de référence (délai client ou délai interne).",
      "Publier un OTIF sans cette règle produirait un chiffre contestable dès le premier comité.",
    ],
  },
