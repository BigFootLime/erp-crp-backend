...
describe("issue #227 — RBAC fail-closed", () => {
  it.each([
    ...
    ["Comptable", "einvoice_submit", true],
    ["Directeur", "einvoice_reconcile", true],
    ["Administrateur Systeme et Reseau", "einvoice_read", true],
    ["Administrateur Systeme et Reseau", "einvoice_admin", true],
    ["Administrateur Systeme et Reseau", "einvoice_submit", false],
    ["Secretaire", "einvoice_read", false],
