...
import {readMaterial,configureMaterial,confirmMaterial,verifyMaterialLot,readOperationReadiness,debitMaterial,customerMaterial,correctDebitMaterial,transferMaterial} from "../controllers/of-material.controller";
import {
  archiveMachine,
  archivePoste,
  createMachine,
...
router.post('/ofs/:id/material/debit-corrections',requireOfCapability('operate'),correctDebitMaterial);
router.post('/ofs/:id/material/transfers',requireOfCapability('operate'),transferMaterial);
router.post('/ofs/:id/material/customer-calls',requireOfCapability('read'),customerMaterial);
