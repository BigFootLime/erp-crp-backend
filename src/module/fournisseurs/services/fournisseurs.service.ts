...
export const replaceFournisseurDomainesSVC = (id: string, body: PutFournisseurDomainesBodyDTO, audit: AuditContext) =>
  repo.repoReplaceFournisseurDomaines(id, body, audit)
