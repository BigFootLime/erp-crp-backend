...
import {
  confirmQuickCommande,
  healthQuickCommande,
  previewQuickCommande,
} from "../controllers/quick-commande.controller";
...
router.get("/health", healthQuickCommande);
router.post("/preview", previewQuickCommande);
router.post("/confirm", confirmQuickCommande);
